...
namespace hdc {
	...
	class SlowTimer : public utils::Singleton<hdc::SlowTimer>, public utils::Runnable {
	public:
		SlowTimer();
		~SlowTimer();
	...
	class Global : public utils::Singleton<hdc::Global>, public TimerNotify {
		asio::io_service io_service_;
