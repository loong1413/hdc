...
namespace hdc {
	...
	*/
	...
	const char *General::hdc_VERSION = "1.0.0";
	...
	const char *General::CONFIG_FILE = "config/hdc.json";
	const char *General::MONITOR_CONFIG_FILE = "config/monitor.json";
	const char *General::LOGGER_FILE = "log/hdc.log";
	...
	const char *General::CONTRACT_VALIDATOR_ADDRESS = "HdR1Q4wqhFbAMqYa8hQPjL5hyMmx9HBa";
	const char *General::CONTRACT_FEE_ADDRESS = "hdrLjgR1Q4wqhFbAMqYa8hQPjL5hyMmx9HBa";
